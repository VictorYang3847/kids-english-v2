...
export default function MatchGame() {
  ...
  const [enOrder, setEnOrder] = useState<string[]>([]); // Shuffled order for English column
  ...
  const initGame = useCallback(() => {
    ...
    // Shuffle English column order independently for difficulty
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-400 via-cyan-400 to-teal-500 p-4">
      <div className="max-w-2xl mx-auto">
        ...
        {/* Cards - Chinese on left, English on right (shuffled independently) */}
        <div className="grid grid-cols-2 gap-4">
          ...
          {/* Right column: English (shuffled order) */}
          <div className="space-y-3">
